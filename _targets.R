...
#source("code/2-functions_analysis.R")
...
list(
  ...
  ##        # NMR
  ##        ## spectra
  tar_target(nmr_spectra, nmr_import_spectra("data/nmr-data/nmr_spectra", method = "mnova")),
  ...
  ##        
  ##        ## peaks
  tar_target(nmr_peaks, nmr_import_peaks("data/nmr-data/nmr_peaks", method = "multiple columns")),
